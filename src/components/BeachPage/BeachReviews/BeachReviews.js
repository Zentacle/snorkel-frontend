...
const BeachReviews = (props) => {
    ...
    return (
        <div className={styles.reviewContainer}>
            ...
            <div className={`${styles.reviewsContainer} ${isCollapsed && styles.isCollapsed}`}>
            ...
            {isCollapsed && props.reviews.length && <PrimaryButton onClick={onViewAllClick}>View all {props.reviews.length} reviews</PrimaryButton>}
        </div>
    )
}
